...
select * from tb_produtos where nome Like "%a%"; -- pesuisa para nomes incompletos
SELECT * FROM tb_produtos WHERE preco IN(20,30,40);  -- exatidão
SELECT * FROM tb_produtos WHERE preco BETWEEN 20 AND 40;  -- intervalo
